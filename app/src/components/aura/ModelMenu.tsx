...
export function ModelMenu({ grouped, currentModel, disabled, onSelect }: ModelMenuProps) {
  ...
  return (
    <div className="relative inline-block text-left" ref={ref}>
      <button
        onClick={() => setOpen((o) => !o)}
        className="flex items-center space-x-2 px-3 py-1.5 rounded-xl bg-white/80 hover:bg-slate-100/80 border border-slate-200/80 text-xs font-medium text-slate-700 shadow-sm transition"
      >
      ...
      {open && (
        <div className="absolute right-0 mt-2 w-56 bg-white/95 apple-glass rounded-2xl border border-slate-200/80 shadow-2xl z-50 p-1.5 space-y-1 text-xs">
