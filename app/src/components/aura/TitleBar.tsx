  ...
  return (
    <div className="h-12 px-5 flex items-center justify-between border-b border-slate-200/60 bg-slate-100/50 shrink-0">
      ...
      <div className="flex items-center space-x-2">
        ...
        <span className="ml-4 text-xs font-semibold text-slate-500 tracking-wider uppercase font-pixel">
      ...
      <button
        ...
        className="flex items-center space-x-2 px-3.5 py-1 rounded-xl bg-slate-200 border border-slate-400 hover:bg-slate-300 transition text-xs text-slate-500 shadow-sm"
      >
